...
namespace ThreadLike.Chat.Infrastructure.Database.Migrations
{
    ...
    [Migration("20250423061509_Update_Database_2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ThreadLike.Chat.Domain.Groups.Entities.Participant", b =>
                {
            ...
            modelBuilder.Entity("ThreadLike.Chat.Domain.Groups.Group", b =>
                {
                    ...
                    b.OwnsOne("ThreadLike.Chat.Domain.Groups.Entities.LastMessages", "LastMessage", b1 =>
                        {
                            ...
                            b1.Property<bool>("IsAutoGenerated")
                                .HasColumnType("boolean");

                            b1.Property<string[]>("ReaderIds")
                                .IsRequired()
                                .HasColumnType("text[]");
